function[Leader,Convergence_curve,y_hat,TestCost,StockTesting]=WOA(SearchAgents,newC,Iteration,Test,Train,Target,maxClose,Close1,Days)
...
for t=1:nTarget
    error=transpose(ori_stock{t})-transpose(ori_stock_yhat{t});
    StockTesting(t,:)=RMSE(error,size(Testy_hat{m},1));
end
TestCost=fitness;